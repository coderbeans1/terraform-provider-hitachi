...
- `capacity_manage` (Block List) Capacity manage information (see [below for nested schema](#nestedblock--info--capacity_manage))
...
- `rebuild_capacity_resource_setting` (Block List) Rebuild capacity resource setting information (see [below for nested schema](#nestedblock--info--rebuild_capacity_resource_setting))
- `rebuild_capacity_status` (String) Rebuild capacity status of pool
- `rebuildable_resources` (Block List) Rebuildable resources information (see [below for nested schema](#nestedblock--info--rebuildable_resources))
...
- `saving_effects` (Block List) Saving effects information (see [below for nested schema](#nestedblock--info--saving_effects))
...
<a id="nestedblock--info--capacity_manage"></a>
...
<a id="nestedblock--info--rebuild_capacity_resource_setting"></a>
...
<a id="nestedblock--info--rebuildable_resources"></a>
